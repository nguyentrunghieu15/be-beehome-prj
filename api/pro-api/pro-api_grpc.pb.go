...
func (c *proServiceClient) GetAllServiceOfProvider(ctx context.Context, in *GetAllServiceOfProviderRequest, opts ...grpc.CallOption) (*GetAllServiceOfProviderResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ProService/GetAllServiceOfProvider", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *proServiceClient) GetAllReviewsOfProvider(ctx context.Context, in *GetAllReviewOfProviderRequest, opts ...grpc.CallOption) (*GetAllReviewOfProviderResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ProService/GetAllReviewsOfProvider", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *proServiceClient) DeleteServicePro(ctx context.Context, in *DeleteServiceProRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/ProService/DeleteServicePro", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ProService_GetAllServiceOfProvider_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ProService/GetAllServiceOfProvider",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ProService_GetAllReviewsOfProvider_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ProService/GetAllReviewsOfProvider",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ProService_DeleteServicePro_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ProService/DeleteServicePro",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
