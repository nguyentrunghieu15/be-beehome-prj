...
type ServiceManagerServiceClient interface {
	...
	FulltextSearchServices(ctx context.Context, in *FulltextSearchServicesRequest, opts ...grpc.CallOption) (*ListServicesResponse, error)
...
func (c *serviceManagerServiceClient) ListServices(ctx context.Context, in *ListServicesRequest, opts ...grpc.CallOption) (*ListServicesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ServiceManagerService/ListServices", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *serviceManagerServiceClient) FulltextSearchServices(ctx context.Context, in *FulltextSearchServicesRequest, opts ...grpc.CallOption) (*ListServicesResponse, error) {
	out := new(ListServicesResponse)
	err := c.cc.Invoke(ctx, "/ServiceManagerService/FulltextSearchServices", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *serviceManagerServiceClient) GetService(ctx context.Context, in *GetServiceRequest, opts ...grpc.CallOption) (*Service, error) {
	out := new(Service)
	err := c.cc.Invoke(ctx, "/ServiceManagerService/GetService", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *serviceManagerServiceClient) CreateService(ctx context.Context, in *CreateServiceRequest, opts ...grpc.CallOption) (*Service, error) {
	out := new(Service)
	err := c.cc.Invoke(ctx, "/ServiceManagerService/CreateService", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *serviceManagerServiceClient) UpdateService(ctx context.Context, in *UpdateServiceRequest, opts ...grpc.CallOption) (*Service, error) {
	out := new(Service)
	err := c.cc.Invoke(ctx, "/ServiceManagerService/UpdateService", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *serviceManagerServiceClient) DeleteService(ctx context.Context, in *DeleteServiceRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, "/ServiceManagerService/DeleteService", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ServiceManagerServiceServer interface {
	...
	FulltextSearchServices(context.Context, *FulltextSearchServicesRequest) (*ListServicesResponse, error)
...
func (UnimplementedServiceManagerServiceServer) FulltextSearchServices(context.Context, *FulltextSearchServicesRequest) (*ListServicesResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method FulltextSearchServices not implemented")
}
...
func _ServiceManagerService_ListServices_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ServiceManagerService/ListServices",
	}
...
func _ServiceManagerService_FulltextSearchServices_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FulltextSearchServicesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ServiceManagerServiceServer).FulltextSearchServices(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ServiceManagerService/FulltextSearchServices",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ServiceManagerServiceServer).FulltextSearchServices(ctx, req.(*FulltextSearchServicesRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _ServiceManagerService_GetService_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ServiceManagerService/GetService",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ServiceManagerService_CreateService_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ServiceManagerService/CreateService",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ServiceManagerService_UpdateService_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ServiceManagerService/UpdateService",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ServiceManagerService_DeleteService_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ServiceManagerService/DeleteService",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var ServiceManagerService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "FulltextSearchServices",
			Handler:    _ServiceManagerService_FulltextSearchServices_Handler,
		},
		{
