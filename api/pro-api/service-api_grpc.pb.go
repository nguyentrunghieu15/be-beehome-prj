...
const (
	...
	ServiceManagerService_FulltextSearchServices_FullMethodName = "/ServiceManagerService/FulltextSearchServices"
...
func (c *serviceManagerServiceClient) FulltextSearchServices(ctx context.Context, in *FulltextSearchServicesRequest, opts ...grpc.CallOption) (*ListServicesResponse, error) {
	out := new(ListServicesResponse)
	err := c.cc.Invoke(ctx, ServiceManagerService_FulltextSearchServices_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ServiceManagerService_FulltextSearchServices_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ServiceManagerService_FulltextSearchServices_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
